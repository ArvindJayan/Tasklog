            ...
            <form id="createTaskForm">
                <div class="modal-body">
                    <?php if ($this->session->userdata('role_id') == 2): ?>
                        <div class="mb-3">
                            <label class="form-label text-secondary">Assign To</label>

                            <select class="form-select" name="assigned_to" required>
                                <option
                                    value="<?= $this->Employee_model->get_employee_by_user_id($this->session->userdata('user_id'))->id; ?>">
                                    Myself
                                </option>

                                <?php foreach (
                                    $this->Employee_model->get_employees_by_ra(
                                        $this->Employee_model->get_employee_by_user_id(
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <label class="form-label text-secondary">Estimated Duration</label>
                            <input type="number" class="form-control" name="estimated_duration" min="1" step="1"
                                placeholder="Minutes">
                        </div>
        ...
        <div class="modal-content bg-surface border-tasklog text-white">
            ...
            <div class="modal-body">
                <div id="viewTaskLoading" class="text-center py-5">
                    ...
                    <p class="text-secondary mt-3 mb-0">Loading task...</p>
                </div>

                <div id="viewTaskContent" class="d-none">
                    <div class="mb-4">
                        <div class="view-label">Task</div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            <div class="view-label">Estimated Duration</div>
                            <div class="view-value" id="viewTaskEstimatedDuration"></div>
                        </div>

                        <div class="col-md-3">
                            <div class="view-label">Actual Duration</div>
                            <div class="view-value" id="viewTaskActualDuration"></div>
                        </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="view-label">Assigned By</div>
        ...
        <div class="modal-content bg-surface border-tasklog text-white">
            ...
            <form id="editTaskForm">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label text-secondary">Task Title</label>
                        <input type="text" class="form-control" name="title" id="editTitle" maxlength="200" required>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control" name="estimated_duration"
                                id="editEstimatedDuration" min="1" step="1" placeholder="Minutes">
                        </div>
