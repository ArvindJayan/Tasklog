...
<head>
	...
	<style>
		...
		.bg-surface {
			background-color: rgba(17, 24, 39, 0.50) !important;
		}
					...
					<div class="col-lg-6">
						<div class="card bg-surface border-tasklog rounded-4">
							<div class="card-body p-4">
								...
								<div
									class="d-flex justify-content-between align-items-center py-3 border-bottom border-tasklog">
									<div>
				...
				<div class="row g-4">
					<div class="col-md-4">
						<div class="card h-100 bg-surface border-tasklog rounded-4 feature-card">
							<div class="card-body p-4">
								<div class="feature-icon text-cyan mb-3">
									<i class="bi bi-check2-square"></i>
								</div>
								<h5 class="fw-semibold text-light">Task Management</h5>
								<p class="text-secondary mb-0">
									Create, assign, prioritize, and track tasks from one simple workspace.
								</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="card h-100 bg-surface border-tasklog rounded-4 feature-card">
							<div class="card-body p-4">
								...
								<p class="text-secondary mb-0">
									Reporting authorities can assign tasks directly to their employees.
								</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="card h-100 bg-surface border-tasklog rounded-4 feature-card">
							<div class="card-body p-4">
								...
								<p class="text-secondary mb-0">
									Keep a history of task assignments and updates through audit logging.
								</p>
							</div>
						</div>
					</div>
